...
model{
  ...
  for (i in 1:N) {
    p[i] <- m_Intercept_inc2_inc3_inc4_inc5_by_state[state[i], 1] + m_Intercept_inc2_inc3_inc4_inc5_by_state[state[i], 2] * inc2[i] + m_Intercept_inc2_inc3_inc4_inc5_by_state[state[i], 3] * inc3[i] + m_Intercept_inc2_inc3_inc4_inc5_by_state[state[i], 4] * inc4[i] + m_Intercept_inc2_inc3_inc4_inc5_by_state[state[i], 5] * inc5[i];
  }
