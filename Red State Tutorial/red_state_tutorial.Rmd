...
```{r Ind Income by state Plot CT, ref.label = c('Ind Income by state Plot MS', 'Ind Income by state Plot OH', 'Ind Income by state Plot CT'), results = "hold", message = F, tidy=TRUE,  tidy.opts=list(width.cutoff=50), echo = 9:10, fig.pos="!H"}
#Plot CT
